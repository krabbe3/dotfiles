...
def _get_location_from_best(obj):
    ...
    lower_right_legend = np.array(
        [x1_legend[0], x0_legend[1]], dtype=np.float64
    )
    upper_left_legend = np.array(
        [x0_legend[0], x1_legend[1]], dtype=np.float64
    )
